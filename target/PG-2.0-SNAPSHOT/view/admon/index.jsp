<%-- 
    Document   : indexadmon
    Created on : Aug 26, 2021, 9:12:16 PM
    Author     : marcial
--%>
...
<%
    if (session.getAttribute("user") != null && session.getAttribute("role").equals("ADMINISTRADOR")) {
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="srvLog?action=home">Inicio</a>
                        </li>
                        <li class="nav-item">
